...
import com.frapee.JwtSecurityDemo.controllers.AdminController;
...
public class TestAdminControllerREST {
    ...
    public void testGet() throws Exception {
        ...
        assertNotNull(response);
        assertEquals(response.getStatusCode(), HttpStatus.OK);
        assertEquals(response.getBody(), AdminController.MESSAGE);
    }
    ...
    public void testCreate() throws Exception {
        ...
        assertEquals(response.getBody(), AdminController.POSTED);        
    }
    ...
    public void testUpdate() throws Exception {
        ...
        assertNotNull(response);
        assertEquals(response.getStatusCode(), HttpStatus.OK);
        assertEquals(response.getBody(), AdminController.PUT);          
    }
