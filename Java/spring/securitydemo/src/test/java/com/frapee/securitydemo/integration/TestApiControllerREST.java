...
import com.frapee.securitydemo.controller.ApiController;
...
public class TestApiControllerREST {
    ...
    public void testGet() throws Exception {
        ...
        assertEquals(response.getBody(), ApiController.MESSAGE);
    }
    ...
    public void testCreate() throws Exception {
        ...
        assertEquals(response.getBody(), ApiController.POSTED);        
    }
    ...
    public void testUpdate() throws Exception {
        ...
        assertNotNull(response);
        assertEquals(response.getStatusCode(), HttpStatus.OK);
        assertEquals(response.getBody(), ApiController.PUT);          
    }
